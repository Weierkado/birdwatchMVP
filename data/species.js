...
export const speciesList = [
  {
    ...
    appearance: "它比我想象的小，停在水边低枝上时，身体只是一小团蓝绿。喙很尖，头却显得大，整只鸟像随时要向水里俯冲。刚看清它的轮廓，它已经贴着水面飞走，只在原处留下一圈细小的涟漪。",
  ...
  },
  {
    ...
    appearance: "我原本以为这种小鸟没什么可看的。靠近以后才发现，它背上的褐色斑纹一层压着一层，脸颊和喉间也有清楚的深色记号。它跳起来很轻，每次停下都抬头看一眼，像把整个草地的动静都放在心上。",
    firstEncounterAppearance: "一只小小的褐色鸟影落在草地边，轻快地跳了两下，又警觉地抬了抬头。",
    nickname: "那只背上有斑纹的小鸟",
    colorPalette: {
      primary: "#7a5a28",
      secondary: "#2a2520",
  ...
  },
  {
    ...
    appearance: "我先听见几段圆润的声音，以为树影里藏着不止一只鸟。找过去以后，只看见一团黑色停在落叶边，橙黄色的嘴把它从阴影里点了出来。它低头翻动叶片，又忽然侧过眼看过来，像早就知道这里有人。",
  ...
  },
  {
    ...
    appearance: "它缩着脖子站在水边，背微微拱起，很久都不换姿势。灰蓝色的身体和岸边石头混在一起，只有红色的眼睛偶尔露出一点光。等我意识到它不是石头时，它已经安静地看了这边很久。",
